...
<head>
    <jsp:include page="/views/admin/common/header.jsp">
        <jsp:param value="添加分校区" name="title"/>
    </jsp:include>
</head>
        ...
        <div class="panel-body">
            <form action="" method="post" class="form form-horizontal"
                ...
                <div class="row clearfix">
                    <label class="form-label col-xs-4 col-sm-3">总校区名称：</label>
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.wmSchool.name}" placeholder="请输入总校区名称"
                               id="parentSchoolName" name="parentSchoolName" datatype="*4-16"
                               nullmsg="总校区名称不可为空" disabled>
                    </div>
                </div>
            ...
            $("#form-area-edit").validate({
                ...
                submitHandler: function (form) {
                    var params = {
                        ...
                        parentId: "${requestScope.wmSchool.wmSchoolId}"
                    };
                    jsonPost("addSchool.do",params,function(res){
