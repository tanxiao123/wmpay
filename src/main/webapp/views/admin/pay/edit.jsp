            ...
            <div class="form-controls col-xs-5 col-sm-10">
               <span class="select-box">
                  <select class="select" size="1" name="defaultConfig" id="defaultConfig">
                        <option value="0">无配置（使用上级配置）</option>
            ...
            <form action="" method="post" class="form form-horizontal"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.wmThirdPayConfig.apiBaseUri}"
                               placeholder="第三方网关不可为空"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.wmThirdPayConfig.appId}"
                               placeholder="应用ID不可为空"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.wmThirdPayConfig.appKey}"
                               placeholder="应用密钥不可为空"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-5 col-sm-8">
                        <input type="text" class="input-text" value="${requestScope.result.wmThirdPayConfig.deviceId}"
                               placeholder="设备ID不可为空"
            ...
            <form action="" method="post" class="form form-horizontal"
                ...
                <div class="row clearfix">
                    <label class="form-label col-xs-4 col-sm-3"><span
                            class="c-red">*</span>应用ID：</label>
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.weChatPayConfig.appId}"
                               placeholder="请填写应用ID"
                ...
                <div class="row clearfix">
                    <label class="form-label col-xs-4 col-sm-3"><span
                            class="c-red">*</span>应用密钥：</label>
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.weChatPayConfig.appKey}"
                               placeholder="请填写应用密钥"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.weChatPayConfig.mchId}"
                               placeholder="请填写商户ID"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.result.weChatPayConfig.mchKey}"
                               placeholder="请填写商户密钥"
