...
<head>
    <jsp:include page="/views/admin/common/header.jsp">
        <jsp:param value="编辑商品" name="title"/>
    </jsp:include>
</head>
<body>
            ...
            <form action="" method="post" class="form form-horizontal"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.wmCommodity.title}" placeholder="请输入商品标题"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${requestScope.wmCommodity.description}" placeholder="请输入商品描述"
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9">
                        <input type="number" class="input-text" value="${requestScope.wmCommodity.total}" placeholder="请输入商品金额"
...
<script>
    $(function(){
         $("#status").val("${requestScope.wmCommodity.status}");
         $("#form-commodity-edit").validate({
             ...
             submitHandler: function (form) {
                 console.log(form);
                 $.post("editCommodity.do",{
                     wmCommodityId: "${requestScope.wmCommodity.wmCommodityId}",
                     title: title.value,
